...
ReseñasRouter.get("/resenas/producto/:id/promedio", getPromedioCalificacion); // Obtener promedio de calificaciones (público)
...
ReseñasRouter.post("/resenas", AuthMiddleware(["consumidor", "productor", "admin"]), postResena); // Crear reseña (cualquier usuario autenticado)
ReseñasRouter.put("/resenas/:id", AuthMiddleware(["consumidor", "productor", "admin"]), putResena); // Editar reseña
